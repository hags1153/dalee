...
- **1.0.5 (build 9)** — **play-for-fun** replays of completed games (banner + Hub prompt; score/streak
  untouched), **visible hint/wrong deductions** (cost on the button + live "★ points" pill + −pts flash),
  and a **full M:SS timer** in a widened header slot (was cramped in a 40px box). On TestFlight; tagged
